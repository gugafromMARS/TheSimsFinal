...
public class Messages {
    ...
    public static final String MOVED_TO = "YOU MOVED TO ";
    public static final String CANT_MOVE = "YOU ALREADY ARE IN THAT ROOM";
    public static final String WRONG_ROOM = "WRONG ROOM, TRY AGAIN!";
    ...
    public static final String WRONG_OPTION = "WRONG OPTION, TRY AGAIN!";
